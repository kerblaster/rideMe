...
<body>
	...
	<%
		try {
			...
			String str = "INSERT INTO messages(toUser, fromUser, body) VALUES(?, ?, ?)";
			PreparedStatement p = con.prepareStatement(str);
			p.setString(1, to);
			p.setString(2, session.getAttribute("user.username").toString());
			...
			out.print("Sending mail failed <br> " + ex);
		}
		%>
</body>
</html>